  ...
  $.fn.cfocus = function (options) {
      ...
      return this.each(function (i) {
          ...
          $(document).mousemove(function (event) {
              ...
              position_info.posX = position_info.oPosX + (xRange * set.move_range * reverse_range);
              position_info.posY = position_info.oPosY + (yRange * set.move_range * reverse_range);


              if(!animateing){
                animateing=1;
                thisObj.animate({left:  position_info.posX,top: position_info.posY}, 800,'swing',function(){
                   animateing=0;
                });
        ...
        // setInterval(alert("A"),500);


         // setInterval(console.log(position_info.posX+"/"+position_info.posY),3000);
